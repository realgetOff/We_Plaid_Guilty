...
const getRouteMeta = (pathname) =>
{
	...
	if (pathname === '/ai-game')               return { title: 'ft_transcendence — AI Neural Sketch',         card: '🤖 AI Neural Engine' };
	if (pathname.startsWith('/ai-lobby'))      return { title: 'ft_transcendence — AI Neural Sketch',         card: '🧠 AI Lobby'         };
	if (pathname.startsWith('/ai-play'))       return { title: 'ft_transcendence — AI Neural Sketch',         card: '🖌️ AI Drawing Phase' };
